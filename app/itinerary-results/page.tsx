...
export default function ItineraryResultsPage() {
  ...
  // 샘플 일정 데이터
  const schedule1 = [
    { id: "1-1", time: "09:00", title: "경복궁 관람", description: "조선왕조의 정궁인 경복궁에서 역사와 문화를 체험해보세요. 수문장 교대식 관람도 가능합니다.", cost: "3,000원" },
    { id: "1-2", time: "12:00", title: "인사동 점심", description: "전통 한식당에서 맛있는 한정식을 즐기며 한국의 전통 맛을 느껴보세요.", cost: "15,000원" },
    { id: "1-3", time: "14:00", title: "명동 쇼핑", description: "한국 최대의 쇼핑거리에서 쇼핑과 다양한 거리음식을 즐겨보세요.", cost: "50,000원" },
    { id: "1-4", time: "18:00", title: "남산타워", description: "서울의 아름다운 야경을 한눈에 볼 수 있는 대표 랜드마크입니다.", cost: "16,000원" }
  ]

  const schedule2 = [
    { id: "2-1", time: "10:00", title: "한강공원 산책", description: "시원한 강바람을 맞으며 자전거를 타거나 피크닉을 즐겨보세요.", cost: "무료" },
    { id: "2-2", time: "13:00", title: "홍대 맛집 투어", description: "젊음의 거리 홍대에서 다양한 맛집과 카페를 탐방해보세요.", cost: "20,000원" },
