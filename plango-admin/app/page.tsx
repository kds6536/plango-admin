      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-400">PlanGo 서비스 현황을 한눈에 확인하세요</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 fade-in">
          ...
          <Card className="card hover:glow transition-all duration-300">
            <div className="p-6">
              <div className="flex flex-row items-center justify-between space-y-0 pb-2">
                <h3 className="text-sm font-medium text-slate-300">월간 수익</h3>
          ...
          <Card className="card hover:glow transition-all duration-300">
            <div className="p-6">
              <div className="flex flex-row items-center justify-between space-y-0 pb-2">
                <h3 className="text-sm font-medium text-slate-300">여행 계획</h3>
          ...
          <div className="p-6">
            ...
            <div className="flex gap-2 mb-6">
              <Button 
                ...
                className={selectedPeriod === 'weekly' ? 'bg-blue-600 text-white' : 'bg-slate-700 text-slate-300'}
              >
                주간
              </Button>
              <Button 
                onClick={() => setSelectedPeriod('monthly')}
                className={selectedPeriod === 'monthly' ? 'bg-blue-600 text-white' : 'bg-slate-700 text-slate-300'}
              >
                월간
              </Button>
              <Button 
                onClick={() => setSelectedPeriod('yearly')}
                className={selectedPeriod === 'yearly' ? 'bg-blue-600 text-white' : 'bg-slate-700 text-slate-300'}
              >
                연간
              </Button>
            </div>
            ...
            <div className="h-64 bg-slate-800 rounded-lg flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-slate-300">수익 차트 ({selectedPeriod})</p>
