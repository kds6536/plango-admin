...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-100 via-blue-100 to-indigo-100 flex items-center justify-center py-12 px-4 relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-32 left-16 w-40 h-40 bg-cyan-400 rounded-full blur-3xl"></div>
        <div className="absolute top-20 right-24 w-32 h-32 bg-blue-400 rounded-full blur-2xl"></div>
        <div className="absolute bottom-40 left-1/4 w-36 h-36 bg-indigo-400 rounded-full blur-3xl"></div>
        <div className="absolute bottom-16 right-16 w-28 h-28 bg-purple-400 rounded-full blur-2xl"></div>
      </div>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="password" type="password" placeholder={t.form.passwordPlaceholder} required />
              </div>
            </div>
            ...
            <div className="text-center text-sm">
              <span className="text-gray-600">{t.form.noAccount} </span>
